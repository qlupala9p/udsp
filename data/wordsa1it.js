...
window.WORDS_IT_A1 = [
  ...
  { word: "avere", pos: "verb", level: "A1", category: "General", definition: "To have. - Sahip olmak.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
  { word: "andare", pos: "verb", level: "A1", category: "General", definition: "To go. - Gitmek.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
  { word: "fare", pos: "verb", level: "A1", category: "General", definition: "To do / make. - Yapmak.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
  ...
  { word: "bere", pos: "verb", level: "A1", category: "Food", definition: "To drink. - İçmek.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
  ...
  { word: "vedere", pos: "verb", level: "A1", category: "General", definition: "To see. - Görmek.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
  { word: "venire", pos: "verb", level: "A1", category: "General", definition: "To come. - Gelmek.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
  { word: "potere", pos: "verb", level: "A1", category: "General", definition: "Can / to be able to. - Yapabilmek.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
  { word: "volere", pos: "verb", level: "A1", category: "General", definition: "To want. - İstemek.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
  { word: "dovere", pos: "verb", level: "A1", category: "General", definition: "Must / to have to. - Zorunda olmak.", example: "Nessuna frase di esempio disponibile per questa parola. - Bu kelime için örnek cümle bulunamadı." },
