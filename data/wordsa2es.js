...
window.WORDS_ES_A2 = [
  ...
  { word: "el hotel", pos: "noun", level: "A2", category: "General", definition: "Hotel. - Otel.", example: "El hotel está cerca del centro. - Otel merkeze yakın." },
  ...
  { word: "el médico", pos: "noun", level: "A2", category: "General", definition: "Doctor. - Doktor.", example: "Tengo cita con el médico mañana. - Yarın doktorda randevum var." },
  { word: "el hospital", pos: "noun", level: "A2", category: "General", definition: "Hospital. - Hastane.", example: "El hospital está al final de la avenida. - Hastane caddenin sonunda." },
  { word: "la farmacia", pos: "noun", level: "A2", category: "General", definition: "Pharmacy. - Eczane.", example: "La farmacia abre los domingos. - Eczane pazar günleri açık." },
  ...
  { word: "la cocina", pos: "noun", level: "A2", category: "General", definition: "Kitchen, cooking. - Mutfak.", example: "La cocina es la habitación más grande. - Mutfak en büyük oda." },
  { word: "el dormitorio", pos: "noun", level: "A2", category: "General", definition: "Bedroom. - Yatak odası.", example: "Mi dormitorio tiene una ventana grande. - Yatak odamda büyük bir pencere var." },
  { word: "el baño", pos: "noun", level: "A2", category: "General", definition: "Bathroom. - Banyo.", example: "El baño está a la derecha. - Banyo sağda." },
  { word: "la ropa", pos: "noun", level: "A2", category: "General", definition: "Clothes. - Giysi, kıyafet.", example: "Guardo la ropa en el armario. - Kıyafetleri dolapta saklarım." },
  { word: "el zapato", pos: "noun", level: "A2", category: "General", definition: "Shoe. - Ayakkabı.", example: "Estos zapatos son muy cómodos. - Bu ayakkabılar çok rahat." },
  { word: "la camisa", pos: "noun", level: "A2", category: "General", definition: "Shirt. - Gömlek.", example: "Lleva una camisa blanca. - Beyaz bir gömlek giyiyor." },
  ...
  { word: "el tiempo", pos: "noun", level: "A2", category: "General", definition: "Weather, time. - Hava durumu, zaman.", example: "El tiempo cambia muy rápido aquí. - Burada hava çok hızlı değişiyor." },
  { word: "la lluvia", pos: "noun", level: "A2", category: "General", definition: "Rain. - Yağmur.", example: "La lluvia no paró en toda la noche. - Yağmur bütün gece durmadı." },
  { word: "el sol", pos: "noun", level: "A2", category: "General", definition: "Sun. - Güneş.", example: "Hoy hace mucho sol. - Bugün hava çok güneşli." },
  { word: "el viento", pos: "noun", level: "A2", category: "General", definition: "Wind. - Rüzgâr.", example: "El viento sopla del norte. - Rüzgâr kuzeyden esiyor." },
  ...
  { word: "viajar", pos: "verb", level: "A2", category: "General", definition: "To travel. - Seyahat etmek.", example: "Me gusta viajar en tren. - Trenle seyahat etmeyi severim." },
  ...
  { word: "leer", pos: "verb", level: "A2", category: "General", definition: "To read. - Okumak.", example: "Leo el periódico cada mañana. - Her sabah gazete okurum." },
  ...
  { word: "empezar", pos: "verb", level: "A2", category: "General", definition: "To begin, to start. - Başlamak.", example: "La película empieza a las nueve. - Film dokuzda başlıyor." },
  ...
  { word: "frío", pos: "adjective", level: "A2", category: "General", definition: "Cold. - Soğuk.", example: "El agua del mar está fría. - Deniz suyu soğuk." },
